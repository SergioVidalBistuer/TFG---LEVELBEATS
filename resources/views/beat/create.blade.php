    ...
    <div class="form-lb">
        ...
        <form action="{{ isset($beat)
            ...
            <div class="form-lb__group">
                ...
                <input id="titulo_beat" class="form-control form-lb__input" type="text" name="titulo_beat" maxlength="140" required
            ...
            <div class="form-lb__row">
                <div class="form-lb__group">
                    ...
                    <input id="genero_musical" class="form-control form-lb__input" type="text" name="genero_musical" maxlength="80"
                           value="{{ old('genero_musical', isset($beat) ? $beat->genero_musical : '') }}" placeholder="Trap, Drill, Lo-Fi...">
                </div>

                <div class="form-lb__group">
                    <label for="tempo_bpm">Tempo (BPM)</label>
                    <input id="tempo_bpm" class="form-control form-lb__input" type="number" name="tempo_bpm"
            ...
            <div class="form-lb__row">
                <div class="form-lb__group">
                    ...
                    @endphp
                    <select id="tono_musical" class="form-select form-lb__select" name="tono_musical">
                ...
                <div class="form-lb__group">
                    ...
                    <input id="estado_de_animo" class="form-control form-lb__input" type="text" name="estado_de_animo" maxlength="80"
            ...
            <div class="form-lb__group">
                ...
                <input id="precio_base_licencia" class="form-control form-lb__input" type="number" step="0.01" name="precio_base_licencia"
            ...
            <div class="form-lb__group">
                ...
                <input id="url_audio_previsualizacion" class="form-control form-lb__input" type="text" name="url_audio_previsualizacion" maxlength="255"
            ...
            <div class="form-lb__group">
                ...
                <input id="url_archivo_final" class="form-control form-lb__input" type="text" name="url_archivo_final" maxlength="255"
            ...
            <div class="form-lb__group">
                ...
                <input id="url_portada_beat" class="form-control form-lb__input" type="text" name="url_portada_beat" maxlength="255"
            ...
            <div class="form-lb__row">
                ...
                <div class="form-lb__group">
                    ...
                    <input id="fecha_publicacion" class="form-control form-lb__input" type="datetime-local" name="fecha_publicacion"
